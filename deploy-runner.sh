...
docker build --pull --rm -f "src/lambda-github-runner/Dockerfile" -t 034828384224.dkr.ecr.us-east-1.amazonaws.com/lambda-github-runner:latest "src/lambda-github-runner"
echo "Runner Built"
